    ...
    if (user) {
      ...
      bcrypt.genSalt(10, (err, salt) => {
        bcrypt.hash(newUser.password, salt, (err, hash) => {
          ...
          const path = `${Constants.verifyText}${Constants.emailverification}${newUser.email}/${newUser.verifyKey}`
          //todo
          ...
          let transporter = nodeMailer.createTransport({
            ...
            secure: false,
            auth: {
              user: 'viktimolog@gmail.com',
              pass: '0402GoD19810402GoD1981'
            },
            tls: {
          ...
          let mailOptions = {
            from: '"Home-Expenses" <Home-Expenses@gmail.com>', // sender address
            to: req.body.email, // list of receivers
            subject: 'Verify email from home-expenses', // Subject line
            html: path // html body
          }
